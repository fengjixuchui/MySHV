...
VOID ShvUtilConvertGdtEntry (_In_ VOID* GdtBase, _In_ UINT16 Offset, _Out_ PVMX_GDTENTRY64 VmxGdtEntry);
...
// OS Layer
DECLSPEC_NORETURN VOID __cdecl ShvOsRestoreContext (_In_ PCONTEXT ContextRecord);
...
#ifndef __BASE_H__
VOID ShvOsDebugPrint (_In_ const char* Format, ...);
#else
VOID ShvOsDebugPrintWide (_In_ const CHAR16* Format, ...);
